...
const handler = async (m, {conn, args, usedPrefix, command}) => {
  ...
  try {
    ...
    try {
      ...
      await conn.sendMessage(m.chat, {video: {url: mediaa.result}, fileName: `error.mp4`, caption: ` ❥ᰰຼ ⃟ᬽ៸┋✿𝕸𝖎𝖐𝖚 𝕹𝖆𝖐𝖆𝖓𝖔-𝕭𝖔𝖙 💙༒★»`, thumbnail: mediaa.thumb, mimetype: 'video/mp4'}, {quoted: m});
      await conn.sendMessage(m.chat, {text: '*🧩 Video Descargado Exitosamente*', edit: key}, {quoted: m});
      enviando = false
    } catch {
      try {
